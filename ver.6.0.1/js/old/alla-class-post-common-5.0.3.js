...
$(document).ready(function () {
    ...
    divOtherExamDiv.html('<a href="https://allaclass.tistory.com/tag/' + examTitle + '%20' + examKind + '" target="_top"><div><span class="allaOtherTitle">\'' + examTitle + ' ' + examKind + '\'</span> 타년도 모의고사</div><div>방송대 ' + examTitle + ' ' + examKind + ' 2019년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2018년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2017년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2016년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2015년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2014년도 / 올에이클래스 모의고사<br>방송대 ' + examTitle + ' ' + examKind + ' 2013년도 / 올에이클래스 모의고사<br></div></a>');
